  ...
  return (
    <>
      ...
      <div className="card p-8 mb-8" data-reveal style={{ ['--reveal-delay' as any]: '140ms' }}>
        <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4">✦ 支持我们</h2>
      ...
      <div className="card p-8 text-center" data-reveal style={{ ['--reveal-delay' as any]: '210ms' }}>
        <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-6">✦ 关注 {siteName}</h2>
