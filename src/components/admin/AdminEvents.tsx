  ...
  return (
    <div className="max-w-2xl mx-auto space-y-3">
      <div className="flex justify-between items-center">
        ...
        <button onClick={startNew} className="btn-pink text-xs !px-4 !py-1.5">
          + 新建日程
        </button>
      </div>
      {loading ? (
          ...
          <div key={e.id} className="frost-card p-4 flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                {e.status === "past" && (
                  <span className="text-[10px] bg-gray-200 text-gray-500 dark:text-gray-400 px-2 py-0.5 rounded-full">
                    已结束
                  </span>
                )}
                {e.status === "upcoming" && (
                  <span className="text-[10px] bg-[var(--accent)]/15 text-[var(--accent)] px-2 py-0.5 rounded-full font-semibold">
                    即将到来
                  </span>
                )}
              </div>
            ...
            <button
              onClick={() => startEdit(e)}
              className="text-xs text-[var(--accent)] hover:opacity-70 px-2 py-1 rounded-full hover:bg-white/40 dark:hover:bg-white/5"
            >
              编辑
            </button>
            <button
              onClick={() => del(e)}
              className="text-xs text-red-400 hover:text-red-600 px-2 py-1 rounded-full hover:bg-red-50 dark:hover:bg-red-900/20"
            >
              删除
            </button>
          </div>
